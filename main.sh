...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To AGELLLS SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}AGELLLS ® ${NC}${YELLOW}(${NC} ${green} AGELLLS TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Agellls/servervps/master/"
...
clear
izinsc="https://raw.githubusercontent.com/Agellls/permission/master/ipvps"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/Agellls/servervps/master/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -q https://raw.githubusercontent.com/Agellls/servervps/master/ssh/udp-custom.sh
